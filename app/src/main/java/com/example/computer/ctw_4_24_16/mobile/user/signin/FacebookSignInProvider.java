package com.example.computer.ctw_4_24_16.mobile.user.signin;
//
...
import com.example.computer.ctw_4_24_16.mobile.util.ThreadUtils;
...
public class FacebookSignInProvider implements SignInProvider {
    ...
    final static int REFRESH_TOKEN_POLLING_INTERVAL_MS = 300;

    /** Number of retries to poll when refreshing the token. */
    final static int REFRESH_TOKEN_POLLING_RETRIES = 50; // 15 seconds
    ...
    public String refreshToken() {
        ...
        if (accessToken == null) {
            ...
            if (accessToken == null) {
                Log.w(LOG_TAG, "Facebook provider exceeded retries refreshing token.");
                return null;
            }
        }
